		...
		: QDialog(parent)
{
    ...
    void Dialog::submit()
    {
        ...
        if (artist.isEmpty() || title.isEmpty()) {
            ...
            int albumId = addNewA1bum(title, artistId);
    ...
    int Dialog::addNewA1bum(const QString &title, int artistId)
    {
    ...
    /*
        The following code is connented out since the example uses an in
